...
def mask_mts_fusion():
    ...
    plugins = {
        ...
        'exddm-trans': [ExDD, {'ex_model_cls': Transformer,
                               'params': {'label_window_size': 0, 'd_model': 128, 'num_heads': 8,
                                          'num_encoder_layers': 10, 'num_decoder_layers': 10,
                                          'dim_ff': 512, 'dropout_rate': 0., 'activation': 'gelu'}}],
    }

    plugin, user_settings = plugins['exddm-lstm']
    ...
    trainer.fit(train_ds,
                ...
                epoch_range=(1, 2000), batch_size=128, shuffle=True,
