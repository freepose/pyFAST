...
from fast.data import Scale, StandardScale, MinMaxScale
...
def main():
    ...
    # ds_params = {'input_window_size': 10, 'output_window_size': 1, 'horizon': 1}
    # (train_ds, val_ds), (scaler, ex_scaler) = load_greek_wind(data_root, '1day', ds_params, 0.001, 0.8, False)
    ...
    modeler = {
        ...
        'ed': [EncoderDecoder, {'rnn_cls': 'minlstm', 'hidden_size': 32, 'num_layers': 1,
                                'bidirectional': False, 'dropout_rate': 0., 'decoder_way': 'mapping'}],
        ...
        'nhits': [NHiTS, {'n_blocks': [1] * 3, 'n_layers': [2] * 8,
                          'hidden_size': [[512, 512]] * 3,
                          'pooling_sizes': [8] * 3, 'downsample_frequencies': [24, 12, 1],
        ...
        'crossformer': [Crossformer, {'d_model': 128, 'num_heads': 8, 'num_encoder_layers': 4, 'num_decoder_layers': 4,
        ...
        'itransformer': [iTransformer, {'d_model': 128, 'num_heads': 4, 'num_encoder_layers': 2, 'dim_ff': 1024,
                                        'activation': 'relu', 'dropout_rate': 0., 'use_instance_scale': False}],
        'timesfm': [TimesFM, {'d_model': 64, 'num_heads': 2, 'num_layers': 2,
                              'dim_ff': 256, 'dropout_rate': 0.}],
        'timer': [Timer, {'patch_len': 4, 'd_model': 64, 'num_heads': 8, 'e_layers': 6, 'dim_ff': 512,
